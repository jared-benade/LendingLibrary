...
def msbuild_settings
    {
      ...
      :verbosity => :minimal,
      :parameters => [ "/m", "/p:TargetProfile=Local", "/toolsVersion:12.0", "/p:VisualStudioVersion=12.0" ],
    }
end
...
dotcover :test_with_nunit_coverage do |dc|
    ...
    dc.filters '+:module=*;class=*;function=*;-:*.Tests;-:*.Tests.Common;-:*.FakeIdentity;-:*.FakeIdentity.Tests'
end
#---------------------------------Run Web Tests--------------------------------
